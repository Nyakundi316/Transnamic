  ...
  return (
    <>
      ...
      <section className="relative bg-foreground text-background pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(139,0,0,0.08),transparent_60%)]" />
        <div className="container mx-auto px-6 lg:px-10 relative">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight max-w-3xl">
            ...
            <span className="text-red-400">trust</span> and excellence.
          </h1>
          <p className="mt-6 text-background/50 max-w-xl text-lg leading-relaxed">
            Since October 2020, Transnamic has been delivering innovative construction and logistics solutions across East &amp; Central Africa.
          </p>
        </div>
      </section>
    </>
